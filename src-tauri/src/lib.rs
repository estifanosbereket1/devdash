...
#[tauri::command]
async fn export_backup(app: tauri::AppHandle, target_path: String) -> Result<usize, String> {
...
#[tauri::command]
async fn import_backup(app: tauri::AppHandle, source_path: String) -> Result<Vec<String>, String> {
